...
/// <summary>UC-18/UC-20 (docs/api/openapi.yaml: GET /wallets/{walletId}/balance). Null → кошелек не найден (404).</summary>
...
/// <summary>История слепков баланса кошелька за период (docs/api/openapi.yaml: GET /wallets/{walletId}/balance-history). Null → кошелек не найден (404).</summary>
