...
Актуальная версия — [UI kit v0.2](design/ui-kit.md): спецификация, [CSS-токены](design/tokens.css), [стили витрины](design/preview.css) и [HTML-витрина](design/preview.html). Пользователь отклонил v0.1 из-за несоответствия выбранному референсу: чёрно-серые непрозрачные панели и бирюзовые кнопки не передавали его стиль. После получения оригинального изображения UI kit переработан по прямому запросу пользователя: индиго, лавандово-розовый свет, стекло с пропусканием цвета сцены, мягкие отражения и локальное затемнение под данными. Новые параметры v0.2 ещё требуют визуального согласования.
...
- [ ] Согласовать конкретные параметры и внешний вид v0.2 с пользователем.
- [ ] Подготовить экранные макеты Login и Wallets на основе согласованного UI kit.
- [ ] Внедрить принятые компоненты и токены в Angular отдельным этапом.
