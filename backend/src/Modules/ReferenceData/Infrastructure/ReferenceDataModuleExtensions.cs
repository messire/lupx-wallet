...
/// <summary>
/// Composition root for the ReferenceData module (schema "reference_data") — called from
/// Host/Program.cs. Registers the DbContext, repositories, and command/query handlers.
/// </summary>
