...
/// <summary>
/// Mapping of BalanceSnapshot → balance_history.balance_snapshots (schema.md) — composite
/// primary key (wallet_id, snapshot_date), no surrogate id (see the comment in
