...
/// <summary>
/// Maps OperationBehaviorKind to reference_data.operation_behavior_kinds (schema.md). Rows
/// are seeded by a migration (HasData) — the only way they appear, with no CRUD via API/UI
/// (ddd-model.md, §2.3).
/// </summary>
