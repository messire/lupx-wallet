...
import { BalanceHistoryApiService } from './balance-history-api.service';

describe('BalanceHistoryApiService', () => {
  let service: BalanceHistoryApiService;
  let httpMock: HttpTestingController;

  beforeEach(() => {
    TestBed.configureTestingModule({ imports: [HttpClientTestingModule] });
    service = TestBed.inject(BalanceHistoryApiService);
