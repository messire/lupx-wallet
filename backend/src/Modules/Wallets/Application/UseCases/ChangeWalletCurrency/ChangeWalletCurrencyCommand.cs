...
/// <summary>UC-06 (docs/api/openapi.yaml: PUT /wallets/{id}/currency) — currency change is allowed only if the wallet has no history (Q15; ADR-0009 case a, same IWalletHistorySource as DeleteWalletCommand).</summary>
