...
/// <summary>
/// HTTP endpoints of the ExchangeRates module (docs/api/openapi.yaml, tag ExchangeRates) —
/// called from Host/Program.cs inside the /api/v1 group, already protected by RequireAuthorization().
/// </summary>
