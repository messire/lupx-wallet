...
export class WalletsComponent implements OnInit {
  ...
  /** shared/money/money.ts — форматирование Money для таблицы, без приведения к number. */
  ...
  /** UC-07: список по умолчанию скрывает архивные кошельки (WalletsApiService.list). */
