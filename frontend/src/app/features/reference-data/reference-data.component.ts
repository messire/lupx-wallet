...
import { Currency, OperationBehaviorKind, OperationType, ReferenceItem } from './reference-data.models';
 ...
 *
 * HTTP-вызовы идут только через ReferenceDataService — тот же сервис, что используют
