...
/// <summary>
/// Маппинг Transfer → operations.transfers (schema.md). source_operation_id/
/// target_operation_id — обычные колонки без EF-уровня отношения; FK на
/// operations.operations и их UNIQUE-ограничения добавлены raw SQL в миграции
/// (см. OperationConfiguration — та же циклическая зависимость).
/// </summary>
