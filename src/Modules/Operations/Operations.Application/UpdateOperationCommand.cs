...
/// <summary>UC-13 (docs/api/openapi.yaml: PATCH /operations/{id}) — каскадный пересчет
/// истории (Q4) относится к BalanceHistory, реагирующей на OperationUpdated (ADR-0008).
/// WalletId — решение пользователя от 2026-09-11: смену кошелька операции реализуем как
/// перенос, эквивалентный удалению со старого кошелька + созданию на новом (см.
/// UpdateOperationCommandHandler.Handle).</summary>
