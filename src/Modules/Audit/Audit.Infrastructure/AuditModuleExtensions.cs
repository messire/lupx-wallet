...
/// Регистрирует DbContext, репозиторий и подписчиков на доменные события всех модулей
/// (ADR-0010) — обработчики живут в Infrastructure, регистрируются вручную (не через
/// MediatR.RegisterServicesFromAssembly, который в Program.cs сканирует только
/// *.Application-сборки, см. ADR-0008/OperationEventHandlers.cs).
/// </summary>
